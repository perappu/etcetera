...
$('.nav.nav-tabs.margin-2em').after("<div style='text-align:center;margin:1%;'><sub>click play for the intended toko profile experience:</sub><audio controls preload='metadata' style='width:300px;'><source src='https://github.com/stokori/etcetera/blob/master/tokomeme.mp3?raw=true' type='audio/mpeg'>Your browser does not support the audio element.</audio><sub>(no sorry you can't have this on your page)</sub></div>");